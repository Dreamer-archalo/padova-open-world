...
const checks=[
 ...
 ['travel only begins from confirmed action',/executeConfirmedTransition\(\)/.test(source)&&/await this\.executeTransition\(\{targetCoords: target, meta\}\)/.test(source)],
 ['quoted fare is retained in pending metadata',/quotedFare: fare/.test(source)&&/meta\.quotedFare/.test(source)],
