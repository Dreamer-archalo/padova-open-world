...
(
  ...
  way["natural"="coastline"](45.3930,12.1950,45.5250,12.3950); // exact island/shore geometry
  rel["natural"="water"]["type"="multipolygon"](45.4080,12.1950,45.5000,12.3850);
  rel["waterway"="riverbank"]["type"="multipolygon"](45.4080,12.1950,45.5000,12.3850);
