...
report.browser={initialQualitySelector:'passed',threeD:'not runnable: cloud Chrome reports GL_RENDERER Disabled',fps:'not measured; controller CPU and draw submissions are not end-user FPS'};
