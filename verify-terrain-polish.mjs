...
const checks={
 ...
 historicPlain:historicLevel.includes('HISTORIC_CENTER_PLAIN')&&historicLevel.includes('strength:.92')&&historicLevel.includes('__historicCenterLevelPlane'),
 riverIndependent:historicLevel.includes('HISTORIC_RIVER_HARD_BUFFER')&&historicLevel.includes('HISTORIC_RIVER_FEATHER')&&historicLevel.includes('waterDistance<=HISTORIC_RIVER_HARD_BUFFER?0'),
