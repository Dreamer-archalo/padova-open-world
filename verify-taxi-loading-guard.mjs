...
const checks=[
 ...
 ['deadline checked before taxi backend readiness',source.indexOf('waited>=GUARANTEED_RELEASE_MS')<source.indexOf('let ready=BASE_CORE_READY.call(this,x,z,radius)')],
