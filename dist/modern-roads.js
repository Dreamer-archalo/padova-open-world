...
export function* modernRoadSteps(batch,segments,terrain,{coarse=false}={}){
 ...
 for(const s of segments){
  ...
  // Vertex order is right-forward-left-forward so the x/z cross product points
  // upward. The old left-forward-right-forward order generated downward normals;
  // DoubleSide hid the culling bug but lighting/camera-grazing artefacts remained.
  ...
  // Bounded fan fills corner wedges; reverse angular order for the same upward
  // winding used by strip sections.
