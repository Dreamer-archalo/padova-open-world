...
function showCamera(){cameraBanner.textContent='CAMERA · '+cameraNames[cameraMode];cameraBanner.hidden=false;cameraBanner.classList.remove('camera-banner-show');void cameraBanner.offsetWidth;cameraBanner.classList.add('camera-banner-show');clearTimeout(cameraTimer);cameraTimer=setTimeout(()=>cameraBanner.hidden=true,240);},1250);}
