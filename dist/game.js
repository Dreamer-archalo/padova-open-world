...
let characterPicker;const cameraRig=new CameraRig();let signals,trams,incidents,gameplay,parachute,speedCameras,taxi=null,taxiMapPick=false,taxiDispatcher=null;const waterRecovery=new WaterRecovery();let terrain,districts;
...
function taxiCanBoard(){return state.mode==='foot'&&taxi?.phase==='ready'&&taxi?.car?.mesh?.visible&&vehicleReach(state,taxi.car)<3.2;}
