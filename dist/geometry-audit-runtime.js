...
export function auditPadovaGeometry(world,opts={}){
 ...
 if(options.mesh)for(const [key,root] of world.loaded)root.traverse(o=>{if(o.isMesh&&!o.isInstancedMesh)auditMesh(o,world,{key,stage:'loaded'},options,report,warn);});
