...
import {InputManager} from '../dist/InputManager.js';
import {TaxiDispatcher} from '../dist/TaxiDispatcher.js';
import {TaxiLoadingOverlay} from '../dist/TaxiLoadingOverlay.js';
import {TaxiDriverNPC} from '../dist/TaxiDriverNPC.js';
...
const t=vm.runInContext('({terrain,waterRecovery,recover,dryRoad,addCar,poseVehicle,travel,falling,state,keys,cars,people,world,scene,player,camera,clock,movePlayer,updateTraffic,updateCamera,updateUI,toggleVehicle,beginMission,cancelMission,updateMission,clearPolice,simulate,graph})',ctx);
export {t,ctx,els};
