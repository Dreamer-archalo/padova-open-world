...
try{
 ...
 assert(ready,'poligono not created at villa');await page.keyboard.press('KeyE');await page.waitForFunction(()=>!!globalThis.__mandriaV5Test?.villaRange?.active,null,{timeout:10000});
 ...
 await page.screenshot({path:'test-artifacts/mandria-v6-scope.png',timeout:25000});await page.keyboard.press('KeyX');
